...
export default function ReactQuestionsPage() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center max-w-7xl mx-auto px-6 md:px-8 py-20 w-full relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl w-full flex flex-col items-center text-center mt-[-8vh]">
          {/* Feature Icon Badge */}
          <div className="mb-8 relative">
            <div className="w-24 h-24 rounded-[32px] bg-white border-2 border-gray-50 shadow-[0_12px_40px_-8px_rgba(0,102,255,0.12)] flex items-center justify-center relative z-10">
              <div className="w-20 h-20 rounded-[24px] bg-newton-blue-50 flex items-center justify-center">
                <Clock size={36} className="text-newton-blue-600" />
              </div>
            </div>
            {/* Floating Sparkles Badge */}
            <div className="absolute -top-2 -right-2 px-2.5 py-1 rounded-full bg-newton-blue-600 text-white text-[9px] font-black uppercase tracking-widest flex items-center gap-1 shadow-lg animate-bounce">
          ...
          <p className="mt-6 text-[1rem] sm:text-[1.125rem] text-[#6B7280] font-medium leading-[1.7] max-w-md">
            We're currently curating the best React interview questions, focusing on hooks, state management, and component patterns. Check back soon!
          </p>

          <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
            <Link
              href="/questions"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-2xl bg-gray-900 text-white font-black text-[11px] uppercase tracking-[0.2em] hover:bg-newton-blue-600 transition-all duration-300 shadow-[0_20px_35px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_35px_-10px_rgba(0,102,255,0.2)] active:scale-95 group"
            >
